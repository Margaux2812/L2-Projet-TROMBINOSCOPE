...
$graph->title->Set("Part d'élèves inscrits dans les groupes de TD");
$graph->title->SetMargin(10);

$b1plot->SetFillColor("#00b33c");
$b1plot->SetColor("#00b33c");
$b1plot->SetLegend("Elèves inscrits dans le groupe de TD");

$b2plot->SetFillColor("#d9d9d9");
$b2plot->SetColor("#b3b3b3");
$b2plot->SetLegend("Elèves manquants dans le groupe de TD");

$b3plot->SetFillColor("#ff8080");
$b3plot->SetColor("#ff0000");
$b3plot->SetLegend("Elèves en trop dans le groupe de TD");
