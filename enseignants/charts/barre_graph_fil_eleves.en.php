...
$graph->title->Set("Portion of students registered in the courses");
$graph->title->SetMargin(10);

$b1plot->SetFillColor("#00b33c");
$b1plot->SetColor("#00b33c");
$b1plot->SetLegend("Students registered in the course");

$b2plot->SetFillColor("#d9d9d9");
$b2plot->SetColor("#b3b3b3");
$b2plot->SetLegend("Students missing in the course");

$b3plot->SetFillColor("#ff8080");
$b3plot->SetColor("#ff0000");
$b3plot->SetLegend("Students in excess in the course");
